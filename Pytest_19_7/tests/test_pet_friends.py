from Pytest_19_7.api import PetFriends
from Pytest_19_7.settings import valid_email, valid_password, invalid_email, invalid_password
import os
...
# 10 тестов для API PetFriends Practicum 19.7:
